...
function DropdownMenuTrigger({ asChild, ...props }: MenuPrimitive.Trigger.Props & { asChild?: boolean }) {
  return <MenuPrimitive.Trigger render={asChild ? undefined : props.render} data-slot="dropdown-menu-trigger" {...props} />
}
