      ...
      <CardContent className="p-5 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <h3 className="font-semibold text-sm text-foreground">
                {plan?.name || t("hosting.planFallbackName", { id: item.plan_id })}
              </h3>
              <Badge className="text-[10px] h-4 px-1.5 border-0 font-medium bg-primary/10 text-primary">
                {item.duration_months} {t("hosting.month")}
              </Badge>
            </div>
            ...
            {isEditingName ? (
              <div className="flex items-center gap-1.5 pt-1">
                <Input
                  ...
                  placeholder={t("hosting.instancePlaceholder")}
              ...
              <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                <span>{t("hosting.instanceLabel")}: <strong className="text-foreground font-mono">{item.custom_name || t("hosting.autoGenerated")}</strong></span>
                <button
                  onClick={() => setIsEditingName(true)}
                  className="text-muted-foreground hover:text-foreground cursor-pointer p-0.5"
                  title={t("hosting.renameContainerTitle")}
                >
          ...
          <div className="text-right sm:self-start">
            ...
            <div className="text-[11px] text-muted-foreground">{formattedMonthly} {t("hosting.perMonth")}</div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between pt-3 border-t border-border/50 text-xs">
          <div className="flex items-center gap-2">
            <span className="text-muted-foreground">{t("hosting.duration")}:</span>
